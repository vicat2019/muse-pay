package com.nucc.util.weixinsdk;
...
import static com.nucc.util.weixinsdk.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    public static void main(String[] args) {
        try {
            ...
            String url = "http://192.168.0.99:8080/nucc/wexin/merchant";
            HttpPost httpPost = new HttpPost(url);

            RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(15000).setConnectTimeout(30000).build();
