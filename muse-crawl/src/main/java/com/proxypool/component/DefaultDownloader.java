...
public class DefaultDownloader extends AbstractDownloader {
    ...
    public Page download(Request request, Task task) {
        ...
        try {
            ...
            driver.get(task.getSite().getDomain());
    ...
    public static PhantomJSDriver getPhantomJSDriver() {
        ...
        //驱动支持
        dcaps.setCapability(PhantomJSDriverService.PHANTOMJS_EXECUTABLE_PATH_PROPERTY, "D:\\chromedriver\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe");
